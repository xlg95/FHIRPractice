...
class PID_Data:
    ...
    patient_death_datetime: datetime | None
...
class Hl7PIDDecoder:
    ...
    def decode_segment(self) -> PID_Data:
        ...
        return PID_Data(pid_fields[1], pid_fields[2], pid_fields[3], pid_fields[5], pid_fields[7], pid_fields[8], pid_fields[11], pid_fields[13], pid_fields[15], pid_fields[16], pid_fields[19], pid_fields[18], str_to_datetime(pid_fields[29], nullable=True))
...
class Hl7TXADecoder:
    ...
    def decode_segment(self) -> TXA_Data:
        ...
        return TXA_Data(txa_fields[1], txa_fields[2], txa_fields[3], txa_fields[4], txa_fields[5], txa_fields[6], txa_fields[7], txa_fields[8], txa_fields[9], txa_fields[10], txa_fields[11], 
...
class OBX_Data_List:
    ...
    def __iter__(self):
        return iter(self.__obx_segment_list)

    def append_obx_segment(self, obx_segment: OBX_Data) -> bool:
...
def str_to_datetime(s: str, nullable: bool=False) -> datetime|None:
    """
    ...
    @param nullable [bool] Zeigt an ob der Datumswert None werden darf oder nicht.. wenn s leer ist und nullable False ist wird eine Exception geraised. default: False

    @return [datetime|None] das datetime Objekt welches aus dem string erzeugt wurde oder None falls kein Wert verfügbar ist  
    """
    if s == '' and not nullable:
        raise ValueError("Ein Datumswert muss hier verpflichtend angegeben werden")
